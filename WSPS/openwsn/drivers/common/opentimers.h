...
#define TIMERTHRESHOLD 10*LSE_64K   //lcg 20180428  pri:10

/// Maximum number of timers that can run concurrently
#define MAX_NUM_TIMERS             4//10
///#define MAX_TICKS_IN_SINGLE_CLOCK  (uint32_t)(((PORT_TIMER_WIDTH)0xFFFFFFFF)>>1)  // lcg  20180425
#define MAX_TICKS_IN_SINGLE_CLOCK	(uint32_t)(((PORT_TIMER_WIDTH)0xFFFFFFFF))//zyx changed 20180823

//#define MAX_TICKS_IN_SINGLE_CLOCK  (uint32_t)(((PORT_TIMER_WIDTH)0xFFFFFFFF))//zyx 20181015
