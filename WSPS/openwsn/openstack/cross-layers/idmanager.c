...
void idmanager_init() 
{
   ...
   idmanager_vars.offset_address=*(__IO uint8_t *)(BASEADDR_FLASH_PARAMETER+OFFSETADDR_MYIP_ADDRESS);
   if(idmanager_vars.offset_address==0)
   {
   ...
   memcpy(&idmanager_vars.myPANID.panid[0],(void const*)(BASEADDR_FLASH_PARAMETER+OFFSETADDR_MYPAN_ADDRESS),2);
   // myPrefix
...
}else
{
   ...
   idmanager_vars.myParentID.type=ADDR_64B;
   #if 1
   if(idmanager_vars.isDAGroot            != TRUE)
   {
		idmanager_vars.my64bID.addr_64b[0]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[1]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[2]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[3]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[4]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[5]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[6]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
		idmanager_vars.my64bID.addr_64b[7]=*(__IO uint8_t *)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_MYIP_ADDRESS);
	}else
	{
		idmanager_vars.my64bID.addr_64b[0]=0x20;
		idmanager_vars.my64bID.addr_64b[1]=0x21;
		idmanager_vars.my64bID.addr_64b[2]=0x22;
		idmanager_vars.my64bID.addr_64b[3]=0x23;
		idmanager_vars.my64bID.addr_64b[4]=0x24;
		idmanager_vars.my64bID.addr_64b[5]=0x25;
		idmanager_vars.my64bID.addr_64b[6]=0x26;
		idmanager_vars.my64bID.addr_64b[7]=0x27;
	}
   #else
    memcpy(idmanager_vars.my64bID.addr_64b,(void const*)(BASEADDR_FLASH_PARAMETER+OFFSETADDR_MYMAC_ADDRESS),8);
   #endif
	memcpy(idmanager_vars.myParentID.addr_64b,(void const*)(BASEADDR_FLASH_PARAMETER+OFFSETADDR_MYPARENT_MAC_ADDRESS),8);
   // my16bID
...
void idmanager_init() 
{
...
#else
   idmanager_vars.myPANID.panid[0]     = 0xca;   //lcg 20180602  panid
   ...
   idmanager_vars.myPrefix.prefix[7]   = 0x00;
#endif
#ifndef DAGROOT//only slave has this mode
	idmanager_vars.myParentID.type=ADDR_64B;
	/*it is needed to memcpy the parentID to teh idmanager_vars20180910*/
#endif
   // my64bID
   idmanager_vars.my64bID.type         = ADDR_64B;
   ...
   idmanager_vars.myParentID.addr_64b[0]=0x18;
   idmanager_vars.myParentID.addr_64b[1]=0x50;
   idmanager_vars.myParentID.addr_64b[2]=0x47;
   idmanager_vars.myParentID.addr_64b[3]=0x33;
   idmanager_vars.myParentID.addr_64b[4]=0x58;
   idmanager_vars.myParentID.addr_64b[5]=0x00;
   idmanager_vars.myParentID.addr_64b[6]=0x5B;
   idmanager_vars.myParentID.addr_64b[7]=0x00;
}
...
uint8_t idmanager_getmy_offsetaddress()
{
	uint8_t res;
	DISABLE_INTERRUPTS();
	res=idmanager_vars.offset_address;
	ENABLE_INTERRUPTS();
	return	res;
}
...
open_addr_t* idmanager_getMyParentID() {
   open_addr_t* res;
   INTERRUPT_DECLARATION();
   res= &idmanager_vars.myParentID;
   ENABLE_INTERRUPTS();
...
//=========================== private =========================================
void Read_idmanager_Paraments(void)//added by zyx
{
	if(CheckFlashParamisOK())
	{
		idmanager_vars.offset_address=*(__IO uint8_t *)OFFSETADDR_MYIP_ADDRESS;
		idmanager_vars.slotSkip             = FALSE;
   		if(idmanager_vars.offset_address==0)
   		{
   			idmanager_vars.isDAGroot=TRUE;
		...
		// myPANID
		idmanager_vars.myPANID.type         = ADDR_PANID;
		memcpy(idmanager_vars.myPANID.addr_64b,(uint8_t*)OFFSETADDR_MYPAN_ADDRESS,8);
		// myPrefix
