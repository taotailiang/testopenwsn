...
void ieee802154_prependHeader(OpenQueueEntry_t* msg,
   ...
   packetfunctions_writeAddress(msg,idmanager_getMyID(ADDR_PANID),OW_LITTLE_ENDIAN);//cafe here class address added here zyx20180917
   ...
   *((uint8_t*)(msg->payload)) = temp_8b;
   ...
   /*added by zyx 20181107*/
   if(ieee154e_islowpower()==TRUE)
   {
   	temp_8b|=1<<IEEE154_FCF_LOWPOWERMODE;
   }
   *((uint8_t*)(msg->payload)) = temp_8b;
}
...
*/
ieee802154_header_iht* ieee802514_headertest;
void ieee802154_retrieveHeader(OpenQueueEntry_t*      msg,
   ...
   // function because the packet ends up being shorter than the header.
	ieee802514_headertest=ieee802514_header;
   ...
   ieee802514_header->srcLOWERPOWER_RUN	= (temp_8b >>IEEE154_FCF_LOWPOWERMODE)&0x01;//1b zyx 20180906
   msg->LOWERPOWER_RUN=ieee802514_header->srcLOWERPOWER_RUN;
