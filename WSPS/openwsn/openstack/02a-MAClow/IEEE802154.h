...
enum IEEE802154_fcf_enums {
   ...
   IEEE154_FCF_LOWPOWERMODE		       = 7,//zyx add20180905 to indicate the power state of a slave
...
enum IEEE802154_fcf_type_enums {
   ...
   IEEE154_TYPE_CALLING				   = 6,//zyx added
};
...
typedef struct {
   ...
   bool		   srcLOWERPOWER_RUN;//zyx added20180906
