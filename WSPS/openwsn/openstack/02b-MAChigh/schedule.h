...
*/
// lcg 20180426  #define SLOTFRAME_LENGTH    11 //should be 101
#define SLOTFRAME_LENGTH    12 //should be 101 
#define SLEEP_SUPERFRAME_LENGTH	9//it can be 9 zyx add
//draft-ietf-6tisch-minimal-06
#define SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS                      10 //lcg 20180625//20180628zyx
...
#define NUMSERIALRX          2   //lcg 20180426   pri:3
...
#define NUMSLOTSOFF         0//6  //lcg 20180426   pri:5//20180628zyx
...
typedef enum {
   ...
   CELLTYPE_CALLING	     = 6,//when it is calling zyx20180816
} cellType_t;
