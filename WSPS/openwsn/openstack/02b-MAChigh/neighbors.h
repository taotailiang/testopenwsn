...
#define MaxSlaveNum 3//zyx added 
//#define MaxSlaveNum (*(__IO uint8_t*)(ADDR_PARAMENT_STARTADDRESS+OFFSETADDR_NUMBEROFMOTES)-1)&0x03//4-1=3neighbors
//=========================== typedef =========================================
...
void neighbors_indicateRx(open_addr_t* l2_src,
                          ...
                          uint8_t      joinPrio,
                          bool         insecure,
                          bool		   isLowerPowerRunning) ;//zyx add isLowerPowerRunning 20180906
