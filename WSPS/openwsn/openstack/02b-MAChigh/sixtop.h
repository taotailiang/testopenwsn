...
typedef struct{
	bool FORSE_CALLINGON;
	bool CallingisBUSY;
	uint16_t CallingCounter;
	uint16_t CallingSTOPCNT;
}sixtop_management_calling_vars_t; 
//=========================== prototypes ======================================
...
void 		sixtop_sendSepecialKA(void);
...
void sixtop_change_calling_mode(bool forse_callingon);//zyxadded
